                ...
                <div class="row">
                    <div class="col-md-12 mb-5">
                        ...
                        <div style="display: block" id="BackBtn"  class="p-4 mb-3 bg-white">
                            ...
                            <p><a onclick="goHome()" href="#" style="border-radius: 4px" class="btn btn-primary btn-md text-white">رجوع</a></p>
                        </div>
...
<!--                                        <option disabled selected value>الحالة الطبية</option>-->
                            ...
                            <div class="row form-group">
                                <div class="col-md-6 mb-3 mb-md-0">
                                    ...
                                    <input name="Leye" type="text" id="leftEyeId" class="form-control" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="text-black" for="lname">العين اليمنى</label>
                                    <input name="Reye" type="text" id="RightEyeId" class="form-control" required>
                                </div>
                            </div>
