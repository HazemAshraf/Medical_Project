 ...
 * @author User
 */
@WebServlet(name = "Cancel_Inquiry", urlPatterns = {"/Cancel_Inquiry"})
public class Cancel_Inquiry extends HttpServlet {
...
//                JasperExportManager.exportReportToPdfFile(print,"C:/User/user/Desktop/Test.pdf");
        ...
        if (list.size() > 0) {
            ...
            if (vObj.getCancel().equals(0)) {
                ...
                obj1.addProperty("Cancelled", "false");
                obj1.addProperty("message", "this Request was not cancelled ");
                out.print(obj1.toString());
            } else if (vObj.getCancel().equals(1)) {
                
                obj1.addProperty("Cancelled", "true");
                obj1.addProperty("message", "this Request was cancelled ");
                out.print(obj1.toString());
            }
