...
//                JasperExportManager.exportReportToPdfFile(print,"C:/User/user/Desktop/Test.pdf");
        ...
        if (list.size() > 0) {
            ...
            if (vObj.getCancel().equals(0)) {
                ...
                obj1.addProperty("Cancel", "true");
                obj1.addProperty("message", "Cancelled ");
                out.print(obj1.toString());
            } else if (vObj.getCancel().equals(1)) {
                obj1.addProperty("Cancel", "false");
                obj1.addProperty("message", "this Request has already been calncelled  ");
                out.print(obj1.toString());
            }
