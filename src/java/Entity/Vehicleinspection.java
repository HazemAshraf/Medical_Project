...
public class Vehicleinspection implements Serializable {
    ...
    @Column(name = "shapeDescription")
    private String shapeDescription;
    @Column(name = "requireVehicleSupplies")
    private int requireVehicleSupplies;
    @Column(name = "inspectionServices")
    private String inspectionServices;
    @Column(name = "chassisNo")
    private String chassisNo;
    @Column(name = "plateNo")
    private String plateNo;

    public int getRequireVehicleSupplies() {
        return requireVehicleSupplies;
    }

    public void setRequireVehicleSupplies(int requireVehicleSupplies) {
        this.requireVehicleSupplies = requireVehicleSupplies;
    }

    public String getInspectionServices() {
        return inspectionServices;
    }

    public void setInspectionServices(String inspectionServices) {
